	...
	$mostrar_aviso_mes = false;
		...
		if ($detallado == 'S') {
			...
			if ($mostrar_aviso_mes) {
				$html .= '<tr><td colspan="13" class="text-info"><em>Si el mes seleccionado aún no ha sido depreciado, el sistema mostrará el último mes disponible en el activo.</em></td></tr>';
			}
